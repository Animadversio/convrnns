...
args = edict({
    # "model_name": "ugrnn_intermediate", #'rgc_intermediate',  # Required argument, so no default value is effectively used
    # "out_layers": 'conv7',
...
for chan_id in range(10):
    ...
    for block_i in range(steps):
        ...
        imgs = G.visualize(latent_code).detach().cpu()
